export default function PrimeiraSecao() {
    return (
        ...
        style={{ backgroundImage: "url('/primeiraimagem.jpeg')" }} >
            ...
            <div className="relative z-10 mt-90" data-aos="fade-up" data-aos-duration="2000">
                <h1 className="text-white font-display font-bold text-6xl md:text-6xl lg:text-7xl drop-shadow-xl flex items-center justify-center" ><span>❤️</span>Muito obrigado <span  >❤️</span></h1>
